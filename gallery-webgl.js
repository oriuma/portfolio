// WebGL Background (CPPN Neural Network Shader)
(function() {
    ...
    function render() {
        const time = (performance.now() - startTime) / 1000 * 0.5; // speed = 0.5

        gl.useProgram(program);
        gl.uniform1f(uTimeLocation, time);
        gl.uniform2f(uResolutionLocation, canvas.width, canvas.height);
        gl.uniform1f(uHueShiftLocation, 0);
        gl.uniform1f(uNoiseLocation, 0.02);
        gl.uniform1f(uScanLocation, 0.1);
        gl.uniform1f(uScanFreqLocation, 0.5);
        gl.uniform1f(uWarpLocation, 0.3);
